...
describe("getMove() function", () => {
  ...
  test("should return only set move properties", () => {
    const move = createMove(Square120.E8, Square120.D6);
    const [start, target, captured, flag] = getMove(move);
